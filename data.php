...
// Uji jika klik tombol kirim
if (isset($_GET['hal']) && $_GET['hal'] == "kirim") {
    $id = $_GET['id'];
    $kirim = mysqli_query($koneksi, "UPDATE tbl_berita SET status=1 WHERE no_id='$id'");
    if ($kirim) {
        echo "<script>
            ...
            while ($data = mysqli_fetch_array($tampil)) {
                ...
                echo "</td>
                        <td>
                            ...
                            <a href='data.php?hal=kirim&id={$data['no_id']}' class='btn btn-primary' onclick='return confirm(\"Apakah anda yakin ingin mengirim dokumen ini?\")'>Kirim</a>
                        </td>
                      </tr>";
                $no++;
            }
